package com.example.textbookapplication.widget.pullToRefresh;
...
public class PullToRefreshLayout extends RelativeLayout {
     ...
     * refreshFinish()，
     * loadmoreFinish()，
     * AutoRefreshAndLoadTask.onPostExecute()
     */
    private void hide()
    {
        timer.schedule(5);
